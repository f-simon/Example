...
@Service
public class CreateLifecycleUnsuspendFilter {
    private static final Logger logger = LoggerFactory.getLogger(CreateLifecycleUnsuspendFilter.class);
    ...
    public boolean doValidateRequest(@Header(Constants.PARTNER_ID) final String merchantId,
                                     @Header(Constants.TOKEN_REFERENCE_ID) String tokenReferenceId,
